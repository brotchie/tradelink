...
//    Observable* GetExpandedBook(){return m_expandedBook;}
    ...
    void SetOwner(ExtFrame* lb){m_owningListBox = lb;}
...
//NYSINFO
    ...
    ExtFrame* m_owningListBox;//we will be updating the list box items, so we need a pointer to the list box owning the stock
