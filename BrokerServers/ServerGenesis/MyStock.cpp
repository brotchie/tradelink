...
CMyStock::CMyStock(GTSession &session, LPCSTR pszStock)
...
int CMyStock::OnTick()
{
	...
	//TRACE("CMyStock::OnTick()\n");

	return 0;
}

int CMyStock::OnGotQuotePrint(GTPrint *pRcd)
{
...
int CMyStock::OnExecMsgSending(const GTSending &pRcd)
{
	char ss[256];
...
int CMyStock::OnExecMsgTrade(const GTTrade &pRcd)
{
	char ss[256];
...
int CMyStock::OnExecMsgOpenPosition(const GTOpenPosition &open)
{
