...
Section "TradeLinkSuite"
  ...
  File "TradeLinkCommon\bin\release\TradeLinkCommon.pdb"
  ...
  File "TradeLinkAppKit\bin\release\TradeLinkAppKit.pdb"
  File "TradeLinkAppKit\bin\Release\TradeLinkAppKit.XML"
  File "TradeLinkApi\bin\release\TradeLinkApi.dll"
  File "TradeLinkApi\bin\release\TradeLinkApi.pdb"
  ...
  File "TradeLinkResearch\bin\release\TradeLinkResearch.pdb"
