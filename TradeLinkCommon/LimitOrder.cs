...
namespace TradeLink.Common
{
    ...
    {
        public LimitOrder(string sym, bool side, int size, decimal price, uint orderid) : base(sym, side, size, price, 0, string.Empty, 0, 0) { }
    ...
    {
        public BuyLimit(string sym, int size, decimal price, uint orderid) : base(sym, true, size, price, 0, string.Empty, 0, 0) { }
    ...
    {
        public SellLimit(string sym, int size, decimal price, uint orderid) : base(sym, false, size, price, 0, string.Empty, 0, 0) { }
    ...
    public class BuyOPG : OrderImpl
    {
        ...
        public BuyOPG(string sym, int size, decimal price, uint orderid) : base(sym, true, size, price, 0, string.Empty, 0, 0) { TIF = "OPG"; }
    ...
    public class SellOPG : OrderImpl
    {
        ...
        public SellOPG(string sym, int size, decimal price, uint orderid) : base(sym, false, size, price, 0, string.Empty, 0, 0) { TIF = "OPG"; }
